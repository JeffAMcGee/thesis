...
\[
    \LCR(l_c,L) = { |\{ l_i \mid l_i \in L \land |l_i-l_c|<25 \}|
                    \over |L| }
\]
%
We picked a cutoff distance of 25 miles to distinguish between local and non-local
contacts.
25 miles is \emph{blah} as seen in Figure~\ref{fig:EdgeCounts}.
%
...
\emph{Do we want to look at other metrics similar to local contact ratio?}
