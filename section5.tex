...
%
Unfortunately, adding the time zone information does not improve the location
prediction.
%
...
We also looked at including the geocoded location in the maximum-likelihood
estimation.
%
