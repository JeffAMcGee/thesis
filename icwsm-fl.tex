...
In Finding Your Friends and Following Them to Where You Are, \cite{sadilek2012finding} the authors look at users who post at least 100 geo-located tweets a month in NYC and LA. They reconstruct the social graph from co-occurring geo-located tweets and used dynamic Bayesian networks to predict where a user was at a particular moment in time.
...
%
Based on this sample, we examine the following properties to study how various types of edges correlated with proximity, including
