...
\emph{can I make the absolute value smaller to clean up the pipe space pipe?}
\[
    \LCR(l_c,L) = { |\{ l_i \in L \mid |l_i-l_c|<25 \}|
                    \over |L| }
\]
%
...
\emph{Do we want to talk about other metrics similar to local contact ratio?}
