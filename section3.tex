...
%
Since the target user was selected randomly, they are usually an average
...
We looked at the 100 most recent tweets for the targets and one of their
contacts for each type of their contacts.
%
The edges were divided into groups based on whether the target user
...
We found this pattern for 147669 of the target users.
%
