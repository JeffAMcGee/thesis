...
We evaluated the system using five-fold cross validation.
%
For each of the folds, we ran the tree classifier and generated the curves for
pContact from the training data.
%
\jam{fb and strangers}
%
As seen in Table~\ref{tab:results} our basic FriendlyLocation system predicts
...
\jam{discuss adding other factors}
...
%
\jam{eval for small number of hand-picked and random contacts}
%
