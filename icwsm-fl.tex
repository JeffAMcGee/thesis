...
In Finding Your Friends and Following Them to Where You Are, \cite{sadilek2012finding} the authors look at users who post at least 100 geo-located tweets a month in NYC and LA. They reconstruct the social graph from co-occuring geo-located tweets and used dynamic bayesian networks to perdict where a user was at a particular moment in time.
