...
\item[geocoder calibration users] These are geo-located users who filled out thei
...
any contacts with locationns we could decode, which left us with 1.6 million
...
\emph{What? 10\%+85\% does not make sense.}
