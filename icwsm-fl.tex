...
\DeclareMathOperator{\pContact}{pCon}
\DeclareMathOperator{\pLocation}{pLoc}
\DeclareMathOperator{\pTimeZone}{pTime}
\DeclareMathOperator{\pStrangers}{pStgr}
\DeclareMathOperator{\edges}{edges}
\DeclareMathOperator{\contactEdges}{conEd}
